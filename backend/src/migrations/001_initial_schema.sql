...
CREATE INDEX idx_email_logs_unique_hash ON email_logs(unique_hash);
CREATE INDEX idx_email_logs_status ON email_logs(status);
CREATE INDEX idx_email_logs_created_at ON email_logs(created_at DESC);

-- Composite index for idempotency check
CREATE INDEX idx_email_logs_idempotency ON email_logs(job_id, recipient_email, subject, from_address);
