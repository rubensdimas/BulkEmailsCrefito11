...
for secret_name in POSTGRES_PASSWORD REDIS_PASSWORD MAILGRID_PASS MAILGRID_WEBHOOK_TOKEN CONFIG_ENCRYPTION_KEY OIDC_CLIENT_SECRET OIDC_SESSION_ENCRYPTION_KEY; do
